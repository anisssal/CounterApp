...
public class ListFootBallFrag extends Fragment{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
         v = inflater.inflate(R.layout.activity_list_match_football,container, false);
        getAllMatch();
        init();
    ...
    private void getAllMatch() {
        ...
        list.clear();
        list.addAll(listHelper.getAllUserFt());
    ...
    private void init() {
        ...
        adapt = new RcAdapt(getActivity().getApplicationContext(), list , true);
